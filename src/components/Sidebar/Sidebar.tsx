...
import { ArrowBottom, ArrowTop, Contact, Home, Portfolio, Skills } from '@/assets/icons';
        ...
        <>
            ...
            <div className="md:hidden transition-all flex flex-col gap-3">
                ...
                <button onClick={toggleMobileSidebar}>
                    {showSidebar ? <div className='group w-12 h-12 bg-white rounded-xl flex justify-center items-center shadow-[0px_0px_5px_2px_#cbd5e0] hover:bg-main-dark hover:text-white duration-500 transition-all'><ArrowBottom className="w-10 h-10" /></div> : <div className='group w-12 h-12 bg-white rounded-xl flex justify-center items-center shadow-[0px_0px_5px_2px_#cbd5e0] hover:bg-main-dark hover:text-white duration-500 transition-all'><ArrowTop className="w-10 h-10" /></div>}
                </button>
            </div>
        </>
    );
